...
#SBATCH -D /suffolk/RawGenomicsF/ec474/cite-seq_count4/
#SBATCH -J CITE_SC
...
conda activate /suffolk/Homes/ec474/miniforge3/envs/CITESEQCOUNT
conda list

bash /suffolk/Homes/ec474/scripts/citeseqcount.sh
